...
function Dynamic_Wrap(self, func)
end
...
-- @param float_4 float
-- @param bool_5 bool
function AddFOWViewer(int_1, Vector_2, float_3, float_4, bool_5)
end
...
-- @param float_1 float
-- @param float_2 float
function AngleDiff(float_1, float_2)
end
...
-- @param float_2 float
function AxisAngleToQuaternion(Vector_1, float_2)
end
...
-- @param int_1 int
-- @param handle_2 handle
function CenterCameraOnUnit(int_1, handle_2)
end

---[[ ClearTeamCustomHealthbarColor  ( teamNumber ) ]]
-- @return void
-- @param int_1 int
function ClearTeamCustomHealthbarColor(int_1)
end
...
-- @param float_5 float
-- @param int_6 int
function CreateDamageInfo(handle_1, handle_2, Vector_3, Vector_4, float_5, int_6)
end
...
-- @param string_1 string
-- @param handle_2 handle
function CreateHeroForPlayer(string_1, handle_2)
end
...
-- @param bool_6 bool
-- @param bool_7 bool
function CreateIllusions(handle_1, handle_2, handle_3, int_4, int_5, bool_6, bool_7)
end
...
-- @param handle_2 handle
-- @param handle_3 handle
function CreateItem(string_1, handle_2, handle_3)
end
...
-- @param Vector_1 Vector
-- @param handle_2 handle
function CreateItemOnPositionForLaunch(Vector_1, handle_2)
end
...
-- @param Vector_1 Vector
-- @param handle_2 handle
function CreateItemOnPositionSync(Vector_1, handle_2)
end
...
-- @param int_6 int
-- @param bool_7 bool
function CreateModifierThinker(handle_1, handle_2, string_3, handle_4, Vector_5, int_6, bool_7)
end
...
-- @param Vector_1 Vector
-- @param int_2 int
function CreateRune(Vector_1, int_2)
end
...
-- @param Vector_1 Vector
-- @param float_2 float
function CreateTempTree(Vector_1, float_2)
end
...
-- @param float_2 float
-- @param string_3 string
function CreateTempTreeWithModel(Vector_1, float_2, string_3)
end
...
-- @param Vector_1 Vector
-- @param float_2 float
function CreateTriggerRadiusApproximate(Vector_1, float_2)
end
...
-- @param int_6 int
function CreateUnitByName(string_1, Vector_2, bool_3, handle_4, handle_5, int_6)
end
...
function CreateUnitByNameAsync(string_1, Vector_2, bool_3, handle_4, handle_5, int_6, handle_7)
end
...
-- @param bool_4 bool
-- @param handle_5 handle
function DebugCreateUnit(handle_1, string_2, int_3, bool_4, handle_5)
end
...
-- @param int_7 int
-- @param float_8 float
function DebugDrawBox(Vector_1, Vector_2, Vector_3, int_4, int_5, int_6, int_7, float_8)
end
...
-- @param float_6 float
-- @param float_7 float
function DebugDrawBoxDirection(Vector_1, Vector_2, Vector_3, Vector_4, Vector_5, float_6, float_7)
end
...
-- @param bool_5 bool
-- @param float_6 float
function DebugDrawCircle(Vector_1, Vector_2, float_3, float_4, bool_5, float_6)
end
...
-- @param bool_6 bool
-- @param float_7 float
function DebugDrawLine(Vector_1, Vector_2, int_3, int_4, int_5, bool_6, float_7)
end
...
-- @param bool_4 bool
-- @param float_5 float
function DebugDrawLine_vCol(Vector_1, Vector_2, Vector_3, bool_4, float_5)
end
...
-- @param int_8 int
-- @param float_9 float
function DebugDrawScreenTextLine(float_1, float_2, int_3, string_4, int_5, int_6, int_7, int_8, float_9)
end
...
-- @param bool_5 bool
-- @param float_6 float
function DebugDrawSphere(Vector_1, Vector_2, float_3, float_4, bool_5, float_6)
end
...
-- @param bool_3 bool
-- @param float_4 float
function DebugDrawText(Vector_1, string_2, bool_3, float_4)
end
...
-- @param int_11 int
-- @param bool_12 bool
function DebugScreenTextPretty(float_1, float_2, int_3, string_4, int_5, int_6, int_7, int_8, float_9, string_10, int_11,
                               bool_12)
end
...
function DoCleaveAttack(handle_1, handle_2, handle_3, float_4, float_5, float_6, float_7, string_8)
end
...
function DoEntFire(string_1, string_2, string_3, float_4, handle_5, handle_6)
end
...
-- @param handle_5 handle
-- @param handle_6 handle
function DoEntFireByInstanceHandle(handle_1, string_2, string_3, float_4, handle_5, handle_6)
end
...
-- @param bool_1 bool
-- @param string_2 string
function DoScriptAssert(bool_1, string_2)
end
...
-- @return string
-- @param string_1 string
function DoUniqueString(string_1)
end
...
-- @param handle_3 handle
-- @param int_4 int
function DropNeutralItemAtPositionForHero(string_1, Vector_2, handle_3, int_4)
end
...
-- @param string_1 string
-- @param int_2 int
function EmitAnnouncerSoundForPlayer(string_1, int_2)
end
...
-- @param string_1 string
-- @param int_2 int
function EmitAnnouncerSoundForTeam(string_1, int_2)
end
...
-- @param int_2 int
-- @param Vector_3 Vector
function EmitAnnouncerSoundForTeamOnLocation(string_1, int_2, Vector_3)
end
...
-- @return handle
-- @param int_1 int
function EntIndexToHScript(int_1)
end

---[[ ExecuteOrderFromTable  Issue an order from a script table ]]
-- @return void
-- @param handle_1 handle
function ExecuteOrderFromTable(handle_1)
end
...
-- @param float_2 float
-- @param float_3 float
function ExponentialDecay(float_1, float_2, float_3)
end
...
-- @param handle_2 handle
-- @param int_3 int
function FindClearRandomPositionAroundUnit(handle_1, handle_2, int_3)
end
...
-- @param Vector_2 Vector
-- @param bool_3 bool
function FindClearSpaceForUnit(handle_1, Vector_2, bool_3)
end

---[[ FindSpawnEntityForTeam  Find a spawn point for the given team. ]]
-- @return handle
-- @param int_1 int
function FindSpawnEntityForTeam(int_1)
end
...
--- @param int_7 int
--- @param int_8 int
function FindUnitsInLine(int_1, Vector_2, Vector_3, handle_4, float_5, int_6, int_7, int_8)
end
...
--- @param int_8 int
--- @param bool_9 bool
function FindUnitsInRadius(int_1, Vector_2, handle_3, float_4, int_5, int_6, int_7, int_8, bool_9)
end
...
-- @param string_1 string
-- @param handle_2 handle
function FireGameEvent(string_1, handle_2)
end
...
-- @param string_1 string
-- @param handle_2 handle
function FireGameEventLocal(string_1, handle_2)
end
...
function GetEntityIndexForTreeId(unsigned_1)
end
...
-- @param Vector_1 Vector
-- @param handle_2 handle
function GetGroundHeight(Vector_1, handle_2)
end
...
-- @param Vector_1 Vector
-- @param handle_2 handle
function GetGroundPosition(Vector_1, handle_2)
end
...
-- @param int_1 int
-- @param int_2 int
function GetItemDefOwnedCount(int_1, int_2)
end
...
-- @param int_1 int
-- @param int_2 int
function GetItemDefQuantity(int_1, int_2)
end
...
-- @param int_6 int
-- @param int_7 int
function GetTargetAOELocation(int_1, int_2, int_3, Vector_4, int_5, int_6, int_7)
end
...
-- @param int_6 int
-- @param int_7 int
function GetTargetLinearLocation(int_1, int_2, int_3, Vector_4, int_5, int_6, int_7)
end

---[[ GetTeamHeroKills  ( int teamID ) ]]
-- @return int
-- @param int_1 int
function GetTeamHeroKills(int_1)
end

---[[ GetTeamName  ( int teamID ) ]]
-- @return string
-- @param int_1 int
function GetTeamName(int_1)
end

---[[ GetTreeIdForEntityIndex  Given and entity index of a tree, get the tree id for use for use with with unit orders. ]]
-- @return int
-- @param int_1 int
function GetTreeIdForEntityIndex(int_1)
end
...
-- @return int
-- @param int_1 int
function GetXPNeededToReachNextLevel(int_1)
end
...
-- @param int_1 int
-- @param Vector_2 Vector
function IsLocationVisible(int_1, Vector_2)
end
...
-- @return bool
-- @param handle_1 handle
function IsValidEntity(handle_1)
end
...
-- @param Vector_2 Vector
-- @param float_3 float
function LerpVectors(Vector_1, Vector_2, float_3)
end

---[[ LimitPathingSearchDepth  Set the limit on the pathfinding search space. ]]
-- @return void
-- @param float_1 float
function LimitPathingSearchDepth(float_1)
end
...
-- @param string_2 string
-- @param int_3 int
function LinkLuaModifier(string_1, string_2, int_3)
end
...
-- @return void
-- @param int_1 int
function ManuallyTriggerSpawnGroupCompletion(int_1)
end
...
-- @param int_5 int
-- @param int_6 int
function MinimapEvent(int_1, handle_2, int_3, int_4, int_5, int_6)
end
...
-- @param string_1 string
-- @param handle_2 handle
function PrecacheItemByNameAsync(string_1, handle_2)
end
...
-- @param handle_2 handle
-- @param int_3 int
function PrecacheUnitByNameAsync(string_1, handle_2, int_3)
end
...
-- @param handle_2 handle
-- @param int_3 int
function PrecacheUnitByNameSync(string_1, handle_2, int_3)
end
...
-- @param float_1 float
-- @param float_2 float
function RandomFloat(float_1, float_2)
end
...
-- @param int_1 int
-- @param int_2 int
function RandomInt(int_1, int_2)
end

---[[ RandomVector  Get a random 2D vector of the given length. ]]
-- @return Vector
-- @param float_1 float
function RandomVector(float_1)
end
...
-- @param Vector_1 Vector
-- @param float_2 float
function ResolveNPCPositions(Vector_1, float_2)
end

---[[ RollPercentage  (int nPct) ]]
-- @return bool
-- @param int_1 int
function RollPercentage(int_1)
end
...
-- @param int_2 int
-- @param handle_3 handle
function RollPseudoRandomPercentage(unsigned_1, int_2, handle_3)
end
...
-- @param Vector_2 Vector
-- @param float_3 float
function RotateQuaternionByAxisAngle(Quaternion_1, Vector_2, float_3)
end
...
-- @param string_2 string
-- @param bool_3 bool
function Say(handle_1, string_2, bool_3)
end
...
-- @param int_6 int
-- @param bool_7 bool
function ScreenShake(Vector_1, float_2, float_3, float_4, float_5, int_6, bool_7)
end
...
-- @param int_4 int
-- @param handle_5 handle
function SendOverheadEventMessage(handle_1, int_2, handle_3, int_4, handle_5)
end
...
-- @param string_3 string
-- @param float_4 float
function SetOpvarFloatAll(string_1, string_2, string_3, float_4)
end
...
-- @param float_4 float
-- @param handle_5 handle
function SetOpvarFloatPlayer(string_1, string_2, string_3, float_4, handle_5)
end
...
-- @param ehandle_1 ehandle
-- @param bool_2 bool
function SetRenderingEnabled(ehandle_1, bool_2)
end
...
-- @param int_3 int
-- @param int_4 int
function SetTeamCustomHealthbarColor(int_1, int_2, int_3, int_4)
end
...
-- @param int_3 int
-- @param float_4 float
function ShowCustomHeaderMessage(string_1, int_2, int_3, float_4)
end
...
-- @param string_4 string
-- @param int_5 int
function ShowGenericPopup(string_1, string_2, string_3, string_4, int_5)
end
...
-- @param int_6 int
function ShowGenericPopupToPlayer(handle_1, string_2, string_3, string_4, string_5, int_6)
end
...
-- @param Vector_1 Vector
-- @param float_2 float
function SpawnDOTAShopTriggerRadiusApproximate(Vector_1, float_2)
end
...
-- @param string_1 string
-- @param handle_2 handle
function SpawnEntityFromTableSynchronous(string_1, handle_2)
end
...
-- @param bool_2 bool
-- @param handle_3 handle
function SpawnEntityGroupFromTable(handle_1, bool_2, handle_3)
end
...
-- @param float_3 float
function SplineQuaternions(Quaternion_1, Quaternion_2, float_3)
end
...
-- @param Vector_2 Vector
-- @param float_3 float
function SplineVectors(Vector_1, Vector_2, float_3)
end
...
-- @return bool
-- @param int_1 int
function StopListeningToGameEvent(int_1)
end
...
-- @param float_1 float
-- @param float_2 float
function UTIL_AngleDiff(float_1, float_2)
end
...
-- @param int_5 int
-- @param int_6 int
function UTIL_MessageText(int_1, string_2, int_3, int_4, int_5, int_6)
end
...
-- @param int_4 int
-- @param int_5 int
function UTIL_MessageTextAll(string_1, int_2, int_3, int_4, int_5)
end
...
-- @param int_5 int
-- @param handle_6 handle
function UTIL_MessageTextAll_WithContext(string_1, int_2, int_3, int_4, int_5, handle_6)
end
...
-- @param int_6 int
-- @param handle_7 handle
function UTIL_MessageText_WithContext(int_1, string_2, int_3, int_4, int_5, int_6, handle_7)
end

---[[ UTIL_Remove  Removes the specified entity ]]
-- @return void
-- @param handle_1 handle
function UTIL_Remove(handle_1)
end

---[[ UTIL_RemoveImmediate  Immediately removes the specified entity ]]
-- @return void
-- @param handle_1 handle
function UTIL_RemoveImmediate(handle_1)
end

---[[ UTIL_ResetMessageText  Clear all message text on one client. ]]
-- @return void
-- @param int_1 int
function UTIL_ResetMessageText(int_1)
end
...
-- @param int_4 int
-- @param int_5 int
function UnitFilter(handle_1, int_2, int_3, int_4, int_5)
end
...
-- @return void
-- @param int_1 int
function UnloadSpawnGroupByHandle(int_1)
end
...
-- @param string_1 string
-- @param float_2 float
function cvar_setf(string_1, float_2)
end
...
-- @return Vector
-- @param iAttachment int
function CBaseAnimating:GetAttachmentForward(iAttachment)
end
...
-- @return void
-- @param vValue Vector
function CBaseAnimating:SetGraphLookTarget(vValue)
end
...
-- @param nHand int
-- @param nMuzzle int
function CBaseCombatCharacter:ShootPosition(nHand, nMuzzle)
end
...
-- @param string_1 string
-- @param handle_2 handle
function CCustomGameEventManager:RegisterListener(string_1, handle_2)
end
...
-- @param string_1 string
-- @param handle_2 handle
function CCustomGameEventManager:Send_ServerToAllClients(string_1, handle_2)
end
...
-- @param string_2 string
-- @param handle_3 handle
function CCustomGameEventManager:Send_ServerToPlayer(handle_1, string_2, handle_3)
end
...
-- @param string_2 string
-- @param handle_3 handle
function CCustomGameEventManager:Send_ServerToTeam(int_1, string_2, handle_3)
end

---[[ CCustomGameEventManager:UnregisterListener  ( int ListnerID ) - Unregister a specific listener ]]
-- @return void
-- @param int_1 int
function CCustomGameEventManager:UnregisterListener(int_1)
end
...
-- @param szName string
-- @param nLevel int
function CDOTABaseAbility:GetLevelSpecialValueFor(szName, nLevel)
end
...
-- @return table
-- @param szName string
function CDOTABaseAbility:GetSpecialValueFor(szName)
end
...
-- @param hHero handle
function CDOTABaseGameMode:GetCustomAttributeDerivedStatValue(nDerivedStatType, hHero)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetAbilityTuningValueFilter(hFunction, hContext)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetBountyRunePickupFilter(hFunction, hContext)
end
...
-- @return void
-- @param int_1 int
function CDOTABaseGameMode:SetCustomHeroMaxLevel(int_1)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetDamageFilter(hFunction, hContext)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetExecuteOrderFilter(hFunction, hContext)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetItemAddedToInventoryFilter(hFunction, hContext)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetModifierGainedFilter(hFunction, hContext)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetModifyExperienceFilter(hFunction, hContext)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetModifyGoldFilter(hFunction, hContext)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetRuneSpawnFilter(hFunction, hContext)
end
...
-- @param hFunction handle
-- @param hContext handle
function CDOTABaseGameMode:SetTrackingProjectileFilter(hFunction, hContext)
end
...
-- @return string
-- @param int_1 int
function CDOTAGameManager:GetHeroNameByID(int_1)
end
...
-- @return string
-- @param int_1 int
function CDOTAGameManager:GetHeroUnitNameByID(int_1)
end
...
-- @param string_4 string
-- @param bool_5 bool
function CDOTAGamerules:AddBotPlayerWithEntityScript(string_1, string_2, int_3, string_4, bool_5)
end
...
function CDOTAGamerules:AddEventMetadataLeaderboardEntry(string_1, unsigned_2, unsigned_3, unsigned_4, unsigned_5,
                                                         unsigned_6, unsigned_7, unsigned_8, unsigned_9)
end
...
-- @param int_6 int
-- @param float_7 float
function CDOTAGamerules:AddMinimapDebugPoint(int_1, Vector_2, int_3, int_4, int_5, int_6, float_7)
end
...
-- @param float_7 float
-- @param int_8 int
function CDOTAGamerules:AddMinimapDebugPointForTeam(int_1, Vector_2, int_3, int_4, int_5, int_6, float_7, int_8)
end

---[[ CDOTAGamerules:BeginNightstalkerNight  Begin night stalker night. ]]
-- @return void
-- @param float_1 float
function CDOTAGamerules:BeginNightstalkerNight(float_1)
end

---[[ CDOTAGamerules:BeginTemporaryNight  Begin temporary night. ]]
-- @return void
-- @param float_1 float
function CDOTAGamerules:BeginTemporaryNight(float_1)
end
...
-- @return void
-- @param bool_1 bool
function CDOTAGamerules:EnableCustomGameSetupAutoLaunch(bool_1)
end
...
-- @return handle
-- @param int_1 int
function CDOTAGamerules:GetAnnouncer(int_1)
end
...
-- @return int
-- @param int_1 int
function CDOTAGamerules:GetCustomGameTeamMaxPlayers(int_1)
end
...
-- @param bool_1 bool
-- @param bool_2 bool
function CDOTAGamerules:GetDOTATime(bool_1, bool_2)
end
...
-- @return handle
-- @param int_1 int
function CDOTAGamerules:GetDroppedItem(int_1)
end
...
-- @return table
-- @param int_1 int
function CDOTAGamerules:GetPlayerCustomGameAccountRecord(int_1)
end
...
-- @return void
-- @param bool_1 bool
function CDOTAGamerules:LockCustomGameSetupTeamAssignment(bool_1)
end

---[[ CDOTAGamerules:MakeTeamLose  Makes the specified team lose ]]
-- @return void
-- @param int_1 int
function CDOTAGamerules:MakeTeamLose(int_1)
end
...
-- @return void
-- @param float_1 float
function CDOTAGamerules:PrepareSpawners(float_1)
end

---[[ CDOTAGamerules:RemoveFakeClient  Removes a fake client ]]
-- @return void
-- @param int_1 int
function CDOTAGamerules:RemoveFakeClient(int_1)
end
...
-- @param int_2 int
-- @param int_3 int
function CDOTAGamerules:SendCustomMessage(string_1, int_2, int_3)
end
...
-- @param int_3 int
-- @param int_4 int
function CDOTAGamerules:SendCustomMessageToTeam(string_1, int_2, int_3, int_4)
end

---[[ CDOTAGamerules:SetCreepMinimapIconScale  (flMinimapCreepIconScale) - Scale the creep icons on the minimap. ]]
-- @return void
-- @param float_1 float
function CDOTAGamerules:SetCreepMinimapIconScale(float_1)
end

---[[ CDOTAGamerules:SetCreepSpawningEnabled  Sets whether the regular Dota creeps spawn. ]]
-- @return void
-- @param bool_1 bool
function CDOTAGamerules:SetCreepSpawningEnabled(bool_1)
end
...
-- @return void
-- @param bool_1 bool
function CDOTAGamerules:SetCustomGameAllowBattleMusic(bool_1)
end
...
-- @return void
-- @param bool_1 bool
function CDOTAGamerules:SetCustomGameAllowHeroPickMusic(bool_1)
end
...
-- @return void
-- @param float_1 float
function CDOTAGamerules:SetCustomGameSetupRemainingTime(float_1)
end
...
-- @return void
-- @param float_1 float
function CDOTAGamerules:SetCustomGameSetupTimeout(float_1)
end
...
-- @param int_1 int
-- @param int_2 int
function CDOTAGamerules:SetCustomGameTeamMaxPlayers(int_1, int_2)
end
...
-- @return void
-- @param float_1 float
function CDOTAGamerules:SetCustomVictoryMessageDuration(float_1)
end
...
-- @return void
-- @param bool_1 bool
function CDOTAGamerules:SetHideKillMessageHeaders(bool_1)
end
...
-- @param handle_1 handle
-- @param int_2 int
function CDOTAGamerules:SetOverlayHealthBarUnit(handle_1, int_2)
end
...
-- @return void
-- @param float_1 float
function CDOTAGamerules:SetShowcaseTime(float_1)
end

---[[ CDOTAGamerules:SetStartingGold  Set the starting gold amount. ]]
-- @return void
-- @param int_1 int
function CDOTAGamerules:SetStartingGold(int_1)
end
...
-- @return void
-- @param float_1 float
function CDOTAGamerules:SetStrategyTime(float_1)
end

---[[ CDOTAGamerules:SetTimeOfDay  Set the time of day. ]]
-- @return void
-- @param float_1 float
function CDOTAGamerules:SetTimeOfDay(float_1)
end

---[[ CDOTAGamerules:SetTreeRegrowTime  Sets the tree regrow time in seconds. ]]
-- @return void
-- @param float_1 float
function CDOTAGamerules:SetTreeRegrowTime(float_1)
end
...
-- @return void
-- @param bool_1 bool
function CDOTAGamerules:SetWhiteListEnabled(bool_1)
end
...
-- @return void
-- @param hHero handle
function CDOTAPlayer:CheckForCourierSpawning(hHero)
end
...
-- @return void
-- @param hHero handle
function CDOTAPlayer:SetAssignedHeroEntity(hHero)
end
...
function CDOTAPlayer:SetSelectedHero(pszHeroName)
end

---[[ CDOTAPlayer:SpawnCourierAtPosition  Spawn a courier for this player at the given position. ]]
-- @return handle
-- @param vLocation Vector
function CDOTAPlayer:SpawnCourierAtPosition(vLocation)
end
...
-- @param string_3 string
-- @param bool_4 bool
function CDOTATutorial:AddBot(string_1, string_2, string_3, bool_4)
end
...
-- @param string_3 string
-- @param string_4 string
function CDOTATutorial:AddQuest(string_1, int_2, string_3, string_4)
end

---[[ CDOTATutorial:AddShopWhitelistItem  Add an item to the shop whitelist. ]]
-- @return void
-- @param string_1 string
function CDOTATutorial:AddShopWhitelistItem(string_1)
end
...
-- @return bool
-- @param string_1 string
function CDOTATutorial:IsItemInWhiteList(string_1)
end

---[[ CDOTATutorial:RemoveShopWhitelistItem  Remove an item from the shop whitelist. ]]
-- @return void
-- @param string_1 string
function CDOTATutorial:RemoveShopWhitelistItem(string_1)
end

---[[ CDOTATutorial:SelectHero  Select a hero for the local player ]]
-- @return void
-- @param string_1 string
function CDOTATutorial:SelectHero(string_1)
end
...
-- @param int_1 int
-- @param bool_2 bool
function CDOTATutorial:SetOrModifyPlayerGold(int_1, bool_2)
end

---[[ CDOTATutorial:SetQuickBuy  Set players quick buy item. ]]
-- @return void
-- @param string_1 string
function CDOTATutorial:SetQuickBuy(string_1)
end

---[[ CDOTATutorial:SetShopOpen  Set the shop open or closed. ]]
-- @return void
-- @param bool_1 bool
function CDOTATutorial:SetShopOpen(bool_1)
end

---[[ CDOTATutorial:SetTimeFrozen  Set if we should freeze time or not. ]]
-- @return void
-- @param bool_1 bool
function CDOTATutorial:SetTimeFrozen(bool_1)
end
...
-- @return void
-- @param int_1 int
function CDOTATutorial:SetTutorialUI(int_1)
end

---[[ CDOTATutorial:SetWhiteListEnabled  Set if we should whitelist shop items. ]]
-- @return void
-- @param bool_1 bool
function CDOTATutorial:SetWhiteListEnabled(bool_1)
end
...
-- @return void
-- @param string_1 string
function CDOTATutorial:UpgradePlayerAbility(string_1)
end
...
function CDOTA_Ability_DataDriven:ApplyDataDrivenModifier(hCaster, hTarget, pszModifierName, hModifierTable)
end
...
-- @param table handle
function CDOTA_Ability_Lua:OnHeroDiedNearby(unit, attacker, table)
end
...
-- @param vLocation Vector
-- @param table handle
function CDOTA_Ability_Lua:OnProjectileHit_ExtraData(hTarget, vLocation, table)
end
...
-- @param vLocation Vector
-- @param table handle
function CDOTA_Ability_Lua:OnProjectileThink_ExtraData(vLocation, table)
end
...
function CDOTA_BaseNPC:AddAbility(pszAbilityName)
end
...
-- @param hModifierTable handle
function CDOTA_BaseNPC:AddNewModifier(hCaster, hAbility, pszScriptName, hModifierTable)
end
...
function CDOTA_BaseNPC:FindAbilityByName(pAbilityName)
end
...
-- @param pszScriptName string
-- @param hCaster handle
function CDOTA_BaseNPC:FindModifierByNameAndCaster(pszScriptName, hCaster)
end
...
-- @return handle
-- @param iIndex int
function CDOTA_BaseNPC:GetAbilityByIndex(iIndex)
end
...
---[[ CDOTA_BaseNPC:EOM_GetAttackAnimationPoint   ]]
-- @return float
function CDOTA_BaseNPC:EOM_GetAttackAnimationPoint()
end
...
-- @return handle
-- @param i int
function CDOTA_BaseNPC:GetItemInSlot(i)
end
...
-- @param pszScriptName string
-- @param hCaster handle
function CDOTA_BaseNPC:GetModifierStackCount(pszScriptName, hCaster)
end
...
function CDOTA_BaseNPC:PerformAttack(hTarget, bUseCastAttackOrb, bProcessProcs, bSkipCooldown, bIgnoreInvis,
...
-- @param string_3 string
-- @param handle_4 handle
function CDOTA_CustomUIManager:DynamicHud_Create(int_1, string_2, string_3, handle_4)
end
...
-- @param int_1 int
-- @param string_2 string
function CDOTA_CustomUIManager:DynamicHud_Destroy(int_1, string_2)
end
...
-- @param string_2 string
-- @param handle_3 handle
function CDOTA_CustomUIManager:DynamicHud_SetDialogVariables(int_1, string_2, handle_3)
end
...
-- @param string_2 string
-- @param bool_3 bool
function CDOTA_CustomUIManager:DynamicHud_SetVisible(int_1, string_2, bool_3)
end
...
-- @param attacker handle
-- @param table handle
function CDOTA_Item_Lua:OnHeroDiedNearby(unit, attacker, table)
end
...
function CDOTA_MapTree:CutDown(nTeamNumberKnownTo)
end
...
-- @return void
-- @param table handle
function CDOTA_Modifier_Lua:OnCreated(table)
end
...
-- @return void
-- @param table handle
function CDOTA_Modifier_Lua:OnRefresh(table)
end
...
-- @return unsigned
-- @param nPlayerID int
function CDOTA_PlayerResource:GetEventPointsForPlayerID(nPlayerID)
end

---[[ CDOTA_PlayerResource:GetEventPremiumPoints   ]]
-- @return unsigned
-- @param nPlayerID int
function CDOTA_PlayerResource:GetEventPremiumPoints(nPlayerID)
end

---[[ CDOTA_PlayerResource:GetEventRanks   ]]
-- @return <unknown>
-- @param nPlayerID int
function CDOTA_PlayerResource:GetEventRanks(nPlayerID)
end
...
function CDOTA_PlayerResource:RecordConsumableAbilityChargeChange(iPlayerID, item_definition_index,
...
-- @param bool_4 bool
-- @param float_5 float
function CDebugOverlayScriptHelper:Axis(Vector_1, Quaternion_2, float_3, bool_4, float_5)
end
...
-- @param bool_7 bool
-- @param float_8 float
function CDebugOverlayScriptHelper:Box(Vector_1, Vector_2, int_3, int_4, int_5, int_6, bool_7, float_8)
end
...
function CDebugOverlayScriptHelper:BoxAngles(Vector_1, Vector_2, Vector_3, Quaternion_4, int_5, int_6, int_7, int_8,
                                             bool_9, float_10)
end
...
-- @param bool_9 bool
-- @param float_10 float
function CDebugOverlayScriptHelper:Capsule(Vector_1, Quaternion_2, float_3, float_4, int_5, int_6, int_7, int_8, bool_9,
                                           float_10)
end
...
-- @param bool_8 bool
-- @param float_9 float
function CDebugOverlayScriptHelper:Circle(Vector_1, Quaternion_2, float_3, int_4, int_5, int_6, int_7, bool_8, float_9)
end
...
-- @param bool_7 bool
-- @param float_8 float
function CDebugOverlayScriptHelper:CircleScreenOriented(Vector_1, float_2, int_3, int_4, int_5, int_6, bool_7, float_8)
end
...
-- @param bool_9 bool
-- @param float_10 float
function CDebugOverlayScriptHelper:Cone(Vector_1, Vector_2, float_3, float_4, int_5, int_6, int_7, int_8, bool_9,
                                        float_10)
end
...
-- @param bool_7 bool
-- @param float_8 float
function CDebugOverlayScriptHelper:Cross(Vector_1, float_2, int_3, int_4, int_5, int_6, bool_7, float_8)
end
...
-- @param bool_7 bool
-- @param float_8 float
function CDebugOverlayScriptHelper:Cross3D(Vector_1, float_2, int_3, int_4, int_5, int_6, bool_7, float_8)
end
...
-- @param bool_8 bool
-- @param float_9 float
function CDebugOverlayScriptHelper:Cross3DOriented(Vector_1, Quaternion_2, float_3, int_4, int_5, int_6, int_7, bool_8,
                                                   float_9)
end
...
-- @param bool_9 bool
-- @param float_10 float
function CDebugOverlayScriptHelper:DrawTickMarkedLine(Vector_1, Vector_2, float_3, int_4, int_5, int_6, int_7, int_8,
                                                      bool_9, float_10)
end
...
-- @param float_2 float
-- @param float_3 float
function CDebugOverlayScriptHelper:EntityAttachments(ehandle_1, float_2, float_3)
end
...
-- @param bool_3 bool
-- @param float_4 float
function CDebugOverlayScriptHelper:EntityAxis(ehandle_1, float_2, bool_3, float_4)
end
...
-- @param bool_6 bool
-- @param float_7 float
function CDebugOverlayScriptHelper:EntityBounds(ehandle_1, int_2, int_3, int_4, int_5, bool_6, float_7)
end
...
-- @param ehandle_1 ehandle
-- @param float_2 float
function CDebugOverlayScriptHelper:EntitySkeleton(ehandle_1, float_2)
end
...
-- @param int_7 int
-- @param float_8 float
function CDebugOverlayScriptHelper:EntityText(ehandle_1, int_2, string_3, int_4, int_5, int_6, int_7, float_8)
end
...
-- @param int_6 int
-- @param float_7 float
function CDebugOverlayScriptHelper:FilledRect2D(Vector2D_1, Vector2D_2, int_3, int_4, int_5, int_6, float_7)
end
...
-- @param bool_8 bool
-- @param float_9 float
function CDebugOverlayScriptHelper:HorzArrow(Vector_1, Vector_2, float_3, int_4, int_5, int_6, int_7, bool_8, float_9)
end
...
-- @param bool_7 bool
-- @param float_8 float
function CDebugOverlayScriptHelper:Line(Vector_1, Vector_2, int_3, int_4, int_5, int_6, bool_7, float_8)
end
...
-- @param int_6 int
-- @param float_7 float
function CDebugOverlayScriptHelper:Line2D(Vector2D_1, Vector2D_2, int_3, int_4, int_5, int_6, float_7)
end
...
-- @param bool_9 bool
-- @param float_10 float
function CDebugOverlayScriptHelper:SolidCone(Vector_1, Vector_2, float_3, float_4, int_5, int_6, int_7, int_8, bool_9,
                                             float_10)
end
...
-- @param bool_7 bool
-- @param float_8 float
function CDebugOverlayScriptHelper:Sphere(Vector_1, float_2, int_3, int_4, int_5, int_6, bool_7, float_8)
end
...
-- @param int_9 int
-- @param float_10 float
function CDebugOverlayScriptHelper:SweptBox(Vector_1, Vector_2, Vector_3, Vector_4, Quaternion_5, int_6, int_7, int_8,
                                            int_9, float_10)
end
...
-- @param int_8 int
-- @param float_9 float
function CDebugOverlayScriptHelper:Text(Vector_1, int_2, string_3, float_4, int_5, int_6, int_7, int_8, float_9)
end
...
-- @param float_10 float
function CDebugOverlayScriptHelper:Texture(string_1, Vector2D_2, Vector2D_3, int_4, int_5, int_6, int_7, Vector2D_8,
                                           Vector2D_9, float_10)
end
...
-- @param bool_8 bool
-- @param float_9 float
function CDebugOverlayScriptHelper:Triangle(Vector_1, Vector_2, Vector_3, int_4, int_5, int_6, int_7, bool_8, float_9)
end
...
-- @param bool_8 bool
-- @param float_9 float
function CDebugOverlayScriptHelper:VectorText3D(Vector_1, Quaternion_2, string_3, int_4, int_5, int_6, int_7, bool_8,
                                                float_9)
end
...
-- @param bool_8 bool
-- @param float_9 float
function CDebugOverlayScriptHelper:VertArrow(Vector_1, Vector_2, float_3, int_4, int_5, int_6, int_7, bool_8, float_9)
end
...
-- @param bool_9 bool
-- @param float_10 float
function CDebugOverlayScriptHelper:YawArrow(Vector_1, float_2, float_3, float_4, int_5, int_6, int_7, int_8, bool_9,
                                            float_10)
end
...
-- @param Vector_2 Vector
-- @param float_3 float
function CEntities:FindAllByNameWithin(string_1, Vector_2, float_3)
end

---[[ CEntities:FindAllByTarget  Find entities by targetname. ]]
-- @return table
-- @param string_1 string
function CEntities:FindAllByTarget(string_1)
end
...
-- @param Vector_1 Vector
-- @param float_2 float
function CEntities:FindAllInSphere(Vector_1, float_2)
end
...
-- @param handle_1 handle
-- @param string_2 string
function CEntities:FindByClassname(handle_1, string_2)
end
...
-- @param Vector_2 Vector
-- @param float_3 float
function CEntities:FindByClassnameNearest(string_1, Vector_2, float_3)
end
...
-- @param Vector_3 Vector
-- @param float_4 float
function CEntities:FindByClassnameWithin(handle_1, string_2, Vector_3, float_4)
end
...
-- @param handle_1 handle
-- @param string_2 string
function CEntities:FindByModel(handle_1, string_2)
end
...
-- @param Vector_3 Vector
-- @param float_4 float
function CEntities:FindByModelWithin(handle_1, string_2, Vector_3, float_4)
end
...
-- @param handle_1 handle
-- @param string_2 string
function CEntities:FindByName(handle_1, string_2)
end
...
-- @param Vector_2 Vector
-- @param float_3 float
function CEntities:FindByNameNearest(string_1, Vector_2, float_3)
end
...
-- @param Vector_3 Vector
-- @param float_4 float
function CEntities:FindByNameWithin(handle_1, string_2, Vector_3, float_4)
end
...
-- @param handle_1 handle
-- @param string_2 string
function CEntities:FindByTarget(handle_1, string_2)
end
...
-- @param Vector_2 Vector
-- @param float_3 float
function CEntities:FindInSphere(handle_1, Vector_2, float_3)
end
...
-- @return handle
-- @param handle_1 handle
function CEntities:Next(handle_1)
end
...
-- @param table_4 table
-- @param float_5 float
function CEntityInstance:FireOutput(string_1, handle_2, handle_3, table_4, float_5)
end
...
-- @param string_1 string
-- @param int_2 int
function CEntityInstance:SetIntAttr(string_1, int_2)
end
...
-- @return void
-- @param int_1 int
function CNativeOutputs:Init(int_1)
end
...
-- @return int
function CPropVRHand:GetLiteralHandType()
end
...
-- @return void
-- @param int_1 int
function CSceneEntity:AddBroadcastTeamTarget(int_1)
end
...
-- @return void
-- @param int_1 int
function CSceneEntity:RemoveBroadcastTeamTarget(int_1)
end
...
-- @return handle
-- @param int_1 int
function CScriptHeroList:GetHero(int_1)
end
...
-- @param int_2 int
-- @param handle_3 handle
function CScriptParticleManager:CreateParticle(string_1, int_2, handle_3)
end
...
-- @param handle_3 handle
-- @param handle_4 handle
function CScriptParticleManager:CreateParticleForPlayer(string_1, int_2, handle_3, handle_4)
end
...
-- @param handle_3 handle
-- @param int_4 int
function CScriptParticleManager:CreateParticleForTeam(string_1, int_2, handle_3, int_4)
end
...
-- @return void
-- @param int_1 int
function CScriptParticleManager:SetParticleAlwaysSimulate(int_1)
end
...
-- @param int_2 int
-- @param Vector_3 Vector
function CScriptParticleManager:SetParticleControlFallback(int_1, int_2, Vector_3)
end
...
-- @param Vector_4 Vector
-- @param Vector_5 Vector
function CScriptParticleManager:SetParticleControlOrientation(int_1, int_2, Vector_3, Vector_4, Vector_5)
end
...
-- @param Vector_4 Vector
-- @param Vector_5 Vector
function CScriptParticleManager:SetParticleControlOrientationFLU(int_1, int_2, Vector_3, Vector_4, Vector_5)
end
...
-- @param int_3 int
-- @param float_4 float
function CScriptParticleManager:SetParticleFoWProperties(int_1, int_2, int_3, float_4)
end
...
-- @param int_1 int
-- @param bool_2 bool
function CScriptParticleManager:SetParticleShouldCheckFoW(int_1, bool_2)
end
...
-- @return table
-- @param string_1 string
function Convars:GetBool(string_1)
end
...
-- @param string_3 string
-- @param int_4 int
function Convars:RegisterCommand(string_1, handle_2, string_3, int_4)
end
...
-- @param string_3 string
-- @param int_4 int
function Convars:RegisterConvar(string_1, string_2, string_3, int_4)
end
...
-- @param string_1 string
-- @param bool_2 bool
function Convars:SetBool(string_1, bool_2)
end
...
-- @param string_1 string
-- @param float_2 float
function Convars:SetFloat(string_1, float_2)
end
...
-- @param string_1 string
-- @param int_2 int
function Convars:SetInt(string_1, int_2)
end
...
-- @param string_1 string
-- @param string_2 string
function Convars:SetStr(string_1, string_2)
end
...
-- @param string_1 string
-- @param float_2 float
function GlobalSys:CommandLineFloat(string_1, float_2)
end
...
-- @param string_1 string
-- @param int_2 int
function GlobalSys:CommandLineInt(string_1, int_2)
end
...
-- @param float_2 float
-- @param bool_3 bool
function GridNav:DestroyTreesAroundPoint(Vector_1, float_2, bool_3)
end
...
-- @param float_2 float
-- @param bool_3 bool
function GridNav:IsNearbyTree(Vector_1, float_2, bool_3)
end
...
-- @return int
-- @param float_1 float
function GridNav:WorldToGridPosX(float_1)
end

---[[ GridNav:WorldToGridPosY  Get the Y index of a given world Y position ]]
-- @return int
-- @param float_1 float
function GridNav:WorldToGridPosY(float_1)
end
...
-- @param Vector_2 Vector
-- @param float_3 float
function ProjectileManager:UpdateLinearProjectileDirection(int_1, Vector_2, float_3)
end
