...
function Class:_init(name, parent)
  local a1 = rawget(self, '_methods')
  local a2 = rawget(self, '_requiredMethods')
  local a3 = rawget(self, '_finalMethods')
  local a4 = rawget(self, '_classAttributes')
  local a5 = rawget(self, 'static')
  local methods = a1 and table.wipe(a1) or {}
  local requiredMethods = a2 and table.wipe(a2) or {}
  local finalMethods = a3 and table.wipe(a3) or {}
  local classAttributes = a4 and table.wipe(a4) or {}
  local staticMethods = a5 and table.wipe(a5) or {}
