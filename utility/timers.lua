...
--[[
  ...
  Timers:CreateTimer(function()
      ViDebuger.Record ("Hello. I'm running immediately and then every second thereafter.")
      return 1.0
    end
  )
  ...
  Timers:CreateTimer(5, function()
      ViDebuger.Record ("Hello. I'm running 5 seconds after you called me and then every second thereafter.")
      return 1.0
    end
  )
  ...
  Timers:CreateTimer({
    ...
    callback = function()
      ViDebuger.Record ("Hello. I'm running 10 seconds after when I was started.")
    end
  })
  ...
  Timers:CreateTimer({
    ...
    endTime = 10, -- when this timer should first execute, you can omit this if you want it to run first on the next frame
    callback = function()
      ViDebuger.Record ("Hello. I'm running 10 seconds after I was started even if someone paused the game.")
    end
  })
  ...
  Timers:CreateTimer("uniqueTimerString3", {
    ...
    endTime = 120,
    callback = function()
      ViDebuger.Record ("Hello. I'm running after 2 minutes and then every second thereafter.")
      return 1
    end
  })
  ...
  Timers:CreateTimer("uniqueTimerString3", {
    ...
    callback = function()
      ViDebuger.Record ("Hello. I'm running after 5 seconds and then every second thereafter.")
...
function Timers:Think()
  ...
  for k, v in pairs(Timers.timers) do
    ...
    if now >= v.endTime then
      ...
      if v.context then
        status, nextCall = xpcall(function() return v.callback(v.context, v) end, myerrorhandler)
      else
        status, nextCall = xpcall(function() return v.callback(v) end, myerrorhandler)
      end
